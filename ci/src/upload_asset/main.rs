...
async fn main() -> Result<()> {
    ...
    let mut release_file_name = match target.as_str() {
        "macos" => format!("jenny-{}.dmg", code),
        "ios" => format!("jenny-{}-nosign.ipa", code),
        "windows" => format!("jenny-{}-windows-x86_64.zip", code),
        "linux" => format!("jenny-{}-x86_64.AppImage", code),
        "android-arm32" => format!("jenny-{}-arm32.apk", code),
        "android-arm64" => format!("jenny-{}-arm64.apk", code),
        "android-x86_64" => format!("jenny-{}-x86_64.apk", code),
